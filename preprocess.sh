...
sed -i 's/\\n//g' /home/belal/airflow/scripts/game_details.json
...
# Load the raw data
try:
    with open('/home/belal/airflow/scripts/game_details.json', 'r') as f:
        data = json.load(f)
...
try:
    with open('/home/belal/airflow/scripts/processed_game_details.json', 'w') as f:
